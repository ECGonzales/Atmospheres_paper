...
ax1.annotate('K$\,$I', xy=(0.74, 5.3), color='k', fontsize=12)
...
ax1.annotate('CrH, FeH', xy=(0.996, 5.38), color='k', fontsize=12)
...
ax1.annotate('H$_\mathrm{2} $O', xy=(1.35, 5.4), color='k', fontsize=12)

CIA = pd.DataFrame()
CIA['x'] = [1.8, 2.8]
CIA['y'] = [5.35, 5.35]
ax1.plot(CIA['x'], CIA['y'], color='k')
ax1.annotate('CIA H$_\mathrm{2} $', xy=(2, 5.4), color='k', fontsize=12)
...
ax1.text(0.73, 0.28, 'J0616-6407 (sdL5)', transform=ax1.transAxes, color='darkviolet', fontsize=12)
ax1.text(0.73, 0.24, '$T_\mathrm{eff}: 1720 \pm 280$ K ', transform=ax1.transAxes, color='darkviolet',fontsize=12)
ax1.text(0.73, 0.44, 'J1626+3925 (sdL4)', transform=ax1.transAxes, color='#531CF7', fontsize=12)
ax1.text(0.73, 0.4, '$T_\mathrm{eff}: 2148 \pm 14$ K', transform=ax1.transAxes, color='#531CF7', fontsize=12)
ax1.text(0.73, 0.6, 'J1256-0224 (sdL3.5)', transform=ax1.transAxes, color='k', fontsize=12)
ax1.text(0.73, 0.56, '$T_\mathrm{eff}: 2307 \pm 71$ K', transform=ax1.transAxes, color='k', fontsize=12)
ax1.text(0.73, 0.82, 'J1444-2019 (sdM9)', transform=ax1.transAxes, color='mediumblue', fontsize=12)
ax1.text(0.73, 0.78, '$T_\mathrm{eff}: 2477 \pm 13$ K', transform=ax1.transAxes, color='mediumblue', fontsize=12)
