...
ax1.text(0.73, 0.08, '$T_\mathrm{eff}: 1723 \pm 45$ K ', transform=ax1.transAxes, color='indigo',fontsize=12)
ax1.text(0.73, 0.38, 'J0616-6407 (sdL5)', transform=ax1.transAxes, color='darkviolet', fontsize=12)
ax1.text(0.73, 0.34, '$T_\mathrm{eff}: 1800 \pm 300$ K ', transform=ax1.transAxes, color='darkviolet',fontsize=12)
ax1.text(0.73, 0.54, 'J1626+3925 (sdL4)', transform=ax1.transAxes, color='#531CF7', fontsize=12)
ax1.text(0.73, 0.5, '$T_\mathrm{eff}: 2184 \pm 23$ K', transform=ax1.transAxes, color='#531CF7', fontsize=12)
ax1.text(0.73, 0.68, 'J1256-0224 (sdL3.5)', transform=ax1.transAxes, color='k', fontsize=12)
ax1.text(0.73, 0.64, '$T_\mathrm{eff}: 2400 \pm 320$ K', transform=ax1.transAxes, color='k', fontsize=12)
...
ax1.text(0.72, 0.48, '$T_\mathrm{eff}: 2870 \pm 50$ K', transform=ax1.transAxes, color='#09D67E', fontsize=12)
