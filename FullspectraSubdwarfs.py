...
# -------------- Subdwarfs ----------------------------------
df_0532 = pd.read_csv('Data/Smoothed_data/Subdwarfs_overall_smoothed/0532+8246 (L7sd) SED_smoothed.txt', sep=",",
                      comment='#', header=None, names=["w", "f", "err"])
df_0616 = pd.read_csv('Data/Smoothed_data/Subdwarfs_overall_smoothed/0616-6407 (L5sd) SED_smoothed.txt', sep=",",
                      comment='#', header=None, names=["w", "f", "err"])
...
ax1.text(0.73, 0.34, '$T_\mathrm{eff}: 1730 \pm 280$ K ', transform=ax1.transAxes, color='darkviolet',fontsize=12)
ax1.text(0.73, 0.54, 'J1626+3925 (sdL4)', transform=ax1.transAxes, color='#531CF7', fontsize=12)
ax1.text(0.73, 0.5, '$T_\mathrm{eff}: 2115 \pm 22$ K', transform=ax1.transAxes, color='#531CF7', fontsize=12)
ax1.text(0.73, 0.68, 'J1256-0224 (sdL3.5)', transform=ax1.transAxes, color='k', fontsize=12)
ax1.text(0.73, 0.64, '$T_\mathrm{eff}: 2340 \pm 310$ K', transform=ax1.transAxes, color='k', fontsize=12)
ax1.text(0.73, 0.86, 'J1444-2019 (sdM9)', transform=ax1.transAxes, color='mediumblue', fontsize=12)
ax1.text(0.73, 0.82, '$T_\mathrm{eff}: 2417 \pm 12$ K', transform=ax1.transAxes, color='mediumblue', fontsize=12)
...
ax1.text(0.72, 0.07, '$T_\mathrm{eff}: 2545 \pm 31$ K', transform=ax1.transAxes, color='#015DF7', fontsize=12)
ax1.text(0.72, 0.29, 'LHS 377 (sdM7)', transform=ax1.transAxes, color='#01A1D6',  fontsize=12)
ax1.text(0.72, 0.25, '$T_\mathrm{eff}: 2748 \pm 36$ K', transform=ax1.transAxes, color='#01A1D6', fontsize=12)
ax1.text(0.72, 0.52, 'HD114762$\,$B (d/sdM9)', transform=ax1.transAxes, color='#09D67E', fontsize=12)
ax1.text(0.72, 0.48, '$T_\mathrm{eff}: 2859 \pm 50$ K', transform=ax1.transAxes, color='#09D67E', fontsize=12)
ax1.text(0.72, 0.70, 'J1610-0040 (sdM7)', transform=ax1.transAxes, color='#04A57F', fontsize=12)
ax1.text(0.72, 0.66, '$T_\mathrm{eff}: 2878 \pm 20$ K', transform=ax1.transAxes, color='#04A57F', fontsize=12)
